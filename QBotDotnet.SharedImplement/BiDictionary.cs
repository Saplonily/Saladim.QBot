/*
    repo: https://github.com/Athari/Alba.Framework
    source file in: Alba.Framework/Alba.Framework/Collections/Collections/BiDictionary(TFirst,TSecond).cs
    
    thanks for the implement of bidictionary,
    modified a little
    感谢一个双向映射字典的实现支持
    此文件基于源文件修改过
*/
